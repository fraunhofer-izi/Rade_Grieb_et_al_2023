...
ct.misc = c("#BBBBBB", "#555555", "#332288", "#DDDDDD", "#9e4f6c", "#4f2535", "#555555", "#CCDDAA", "#994455", "#DDDDDD")
names(ct.misc) = c("CD4", "CD8", "NaiveLike", "NE", "S", "G2M", "T_myeloid", "gdT", "Cycling", "Not Estimable")
