...
fin.pl = plot_grid(
  plot_grid(
    ...
    labels = c("b", "", "c", "", "d"), label_fontface = "bold", label_size = 11
  ),
  NULL,
  # NULL,
  plot_grid(adt.ftrs, labels = c("e"), label_fontface = "bold", label_size = 11, vjust = .5),
  nrow = 3, rel_heights  = c(1.5, .1, 1.1)
)

ggsave2(
  filename="code/figures/main/figure_02.png",
  fin.pl,
  width = 180, height = 115, dpi = 400, bg = "white", units = "mm", scale = 1.6
)
